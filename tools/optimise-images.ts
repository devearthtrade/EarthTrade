...
/** Reads a PNG into RGBA8, or returns null for a form this tool will not touch. */
function decode(buf: Buffer): Raster | { skip: string } {
...
function encode(img: Raster, opaque: boolean): Buffer {
